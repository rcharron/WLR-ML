...
[fridge,betaRidge]=ridge(X,Y,1/2);
...
[flasso,Betalasso,errlasso]= manytest(Data,@(X,Y)linearlasso(X,Y,1/3),100);
[fridge,Betaridge,errridge]= manytest(Data,@(X,Y)ridge(X,Y,1/2),1000);
